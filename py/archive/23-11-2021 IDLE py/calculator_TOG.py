...
while restart == "y" or restart == "Y":                                 #as long as restart is equal to yes, the script will loop
    ...
    if numOne == "π" or numOne == "pi" or numOne == "Pi":               #if the first number is π then 
        ...
        operator = input("+ - * / x^y √ ceil floor : ")                            #asks with list of operators to sets 'opp' as
        
        if operator == "√" or operator == "sqrt" or operator == "Sqrt":         #if operator is sqrt
            ansOne = math.sqrt(numOne)                                             #calulates sqrt
        elif operator == "ceil" or operator == "Ceil":                          #if operator is ceiling
            ansOne = math.ceil(numOne)                                             #calulates ceil
        elif operator == "floor" or operator == "Floor":                        #if operator is floor
