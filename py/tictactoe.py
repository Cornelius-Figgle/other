...
def sleep(milliseconds):
    try: milliseconds = int(milliseconds)
    except: return 'Error'
...
def game():
    ...
    def turn_1():
        if 1 in player_moves:
            computer_moves.append(choice(list_1))
            comp()
        elif 2 in player_moves:
            computer_moves.append(choice(list_2))
            comp()
        elif 3 in player_moves:
            computer_moves.append(choice(list_3))
            comp()
        elif 4 in player_moves:
            computer_moves.append(choice(list_4))
            comp()
        elif 5 in player_moves:
            computer_moves.append(choice(list_5))
            comp()
        elif 6 in player_moves:
            computer_moves.append(choice(list_6))
            comp()
        elif 7 in player_moves:
            computer_moves.append(choice(list_7))
            comp()
        elif 8 in player_moves:
            computer_moves.append(choice(list_8))
            comp()
        elif 9 in player_moves:
            computer_moves.append(choice(list_9))
            comp()
    def comp_game():
    ...
    while not win:
        ...
        if attempt in player_moves or attempt in computer_moves:
